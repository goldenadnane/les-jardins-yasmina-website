...
```bash
git remote add encore encore://les-jardins-yasmina-website-r5ei
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/les-jardins-yasmina-website-r5ei/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/les-jardins-yasmina-website-r5ei/settings/integrations/github)
